...
# fit model(s)
tau.bl.l <- compare_ssnet(x = 0.2 * scale(as.matrix(tau.bl.cn.d[, grep("CTX.*",
                                                           names(tau.bl.cn.d), perl = TRUE)])),
...
# save
saveRDS(tau.bl.l, file = "/data/user/jleach/adni/results/tau_bl_cn_d_lasso_grid.rds")
