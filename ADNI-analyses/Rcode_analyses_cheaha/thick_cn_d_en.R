...
# fit model(s)
sc.en <- compare_ssnet(x = 0.2 * scale(as.matrix(sc.cn.d[, grep("ST.*", names(sc.cn.d), perl = TRUE)])),
...
# save
saveRDS(sc.en, file = "/data/user/jleach/adni/results/thickness_sc_cn_d_en_grid.rds")
